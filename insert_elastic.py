...
def elasticSearch(movie_name):
    ...
    es = Elasticsearch(['http://localhost:9200'])  # Replace 'localhost:9200' with your Elasticsearch server address
    ...
    if search_results['hits']['total']['value'] > 0:
        ...
        poster_link = search_results['hits']['hits'][0]['_source']['Poster_Link']
